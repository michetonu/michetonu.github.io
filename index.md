...
My name is **Michele Tonutti**. I am currently based in Amsterdam (NL), where I am Head of Engineering & Data Science at [Pacmed](https://pacmed.ai/en/). We build end-to-end AI-powered applications for clinical decision support, focussing on the Intensive Care Unit and other acute care departments. I have experience in Software / Machine Learning Engineering and Data Science, with an academic background in Medical Engineering and Robotics.
