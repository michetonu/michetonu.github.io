...
My name is **Michele Tonutti**. I am a Software / Machine Learning Engineer and Data Scientist, with an academic background in Medical Engineering and Robotics. I am currently based in Amsterdam (NL), where I work as a Lead Engineer (Software/ML) at [Pacmed](https://pacmed.ai/en/). I am now leading the Software Development team, which builds end-to-end AI-powered applications for clinical decision support on the Intensive Care Unit.
